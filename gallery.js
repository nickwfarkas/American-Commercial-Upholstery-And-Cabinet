...
$(document).ready(function() {
    imgArray.forEach(function(img){
        $('<div id="gic'+String(count)+
            '" class="gallery-image-container"><img src='+
            img+' onclick="openModal();currentSlide('+String(count)+')"/></div>')
                .appendTo('#gallery-container');
        $('<div class="mySlides"><img id="slide'+String(count)+'" src='+img+'></div>')
...
function openModal() {
  ...
  function resize(){
    for (let i = 0; i < count; i++) {
      var img = document.getElementById('slide'+String(i)); 
